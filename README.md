...
- [ ] **Docs: Apologies, but due to other recent projects, the detailed documentation will be provided in October (I'm sorry, like with CTA6, this timeframe has been delayed again). If you encounter any issues during reproduction, please raise an issue or send an email directly.**
## Requirement
